...
def main():
    ...
    reciverMail = findMailOfDev('/var/lib/jenkins/workspace/cf-check-teat/data.json')
    #print(isError)

    if(isError=="error-found"):
        subject="We Got Some Error In Your CloudFormation Template!"
        body="Error are given by attachement!"
        file="/var/lib/jenkins/workspace/cf-check-teat/cf-test/error/error.log"
        ...
        file="/var/lib/jenkins/workspace/cf-check-teat/cf-test/output/output.log"
